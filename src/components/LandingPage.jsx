...
// import {ReactComponent as Earth} from '../assets/earth-removebg-preview.svg'
    ...
    return (
        <div className='landing-page'>
            {/* <div className="load-container">
                <div
                    className="load-screen1 text-wrap"
                    ref={(el) => (screen = el)}
                >
                    <h1
                        style={{
                    ...
                    >
                        donald 'odera' ugobude
                        
                    </h1>
                    
                    <p style={{fontWeight:'100'}}>Product Designer</p>
                    ...
                    <div className="nav-container">
                        ...
                        <div className="nav-links">
                            <ul>
                                <li>
                                    <a 
                                        href="https://www.medium.com/@odera" 
                                        target='_blank'
                                        rel='noreferrer'
                                    >
                                        Blog
